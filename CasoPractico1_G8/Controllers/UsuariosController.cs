...
namespace CasoPractico1_G8.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(CasoPractico1_G8Context context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreUsuario,NombreCompleto,Correo,Telefono,Contraseña,Rol")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
