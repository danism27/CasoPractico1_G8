...
namespace CasoPractico1_G8.Controllers
{
    public class RutasController : Controller
    {
        ...
        {
            var casoPractico1_G8Context = _context.Ruta.Include(r => r.UsuarioRegistro);
        ...
        public async Task<IActionResult> Create([Bind("Id,CodigoRuta,Nombre,Descripcion,Estado,FechaRegistro,UsuarioRegistroId")] Ruta ruta)
        {
            ...
            ViewData["UsuarioRegistroId"] = new SelectList(_context.Usuario, "Id", "Contraseña", ruta.UsuarioRegistroId);
            return View(ruta);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CodigoRuta,Nombre,Descripcion,Estado,FechaRegistro,UsuarioRegistroId")] Ruta ruta)
        {
            if (id != ruta.Id)
            {
                return NotFound();
